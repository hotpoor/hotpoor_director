...
app.whenReady().then(async()=>{
 ...
 try{
  ...
  await wait("document.querySelector('#dialogue-list button')");
  await js("document.querySelector('#dialogue-list button').click()");
  ...
  await js("document.querySelector('#close-dialogue').click();document.querySelector('#open-dialogue').click();");
  await wait("document.querySelector('#dialogue-list button')");await js("document.querySelector('#dialogue-list button').click()");
