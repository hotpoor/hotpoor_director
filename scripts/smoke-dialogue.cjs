...
app.whenReady().then(async()=>{
 ...
 try{
  ...
  if(!await js("(()=>{const a=document.querySelector('.dialogue-answer'),id=a.id.replace('dialogue-answer-',''),v=JSON.parse(localStorage.getItem('dialogue-answer-fonts'));return a.style.fontSize==='13px'&&v[conversationId+':'+id]===0&&document.querySelector('.dialogue-answer-font-button').title.includes('较小')})()"))throw Error('Per-answer font size was not persisted');
