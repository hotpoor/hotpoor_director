(() => {
  ...
  credentialPanel.querySelector('[data-close]').onclick=()=>{credentialPanel.hidden=true;credentialPanel.querySelector('[name=secret]').value='';};
