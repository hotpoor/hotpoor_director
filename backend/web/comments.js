  ...
  async function upload(s,files) {
    ...
    try {
      for(const [i,file] of files.entries()){
        ...
        const cloud=s.el.querySelector('.chat-upload-destination').value==='cloud';
        let a;
